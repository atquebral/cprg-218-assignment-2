...
season1.addEventListener('click',function(){
    ...
    description.innerHTML = "This is the description for season 1";
})
...
season2.addEventListener('click',function(){
    ...
    document.getElementById("introp").innerHTML = "";
    description.innerHTML = "This is the description for season 2";
})
...
season3.addEventListener('click',function(){
    ...
    document.getElementById("introp").innerHTML = "";
    description.innerHTML = "This is the description for season 3";
})
...
season4.addEventListener('click',function(){
    ...
    document.getElementById("introp").innerHTML = "";
    description.innerHTML = "This is the description for season 4";
})
...
season5.addEventListener('click',function(){
    ...
    document.getElementById("introp").innerHTML = "";
    description.innerHTML = "This is the description for season 5";
})
...
season6.addEventListener('click',function(){
    ...
    document.getElementById("introp").innerHTML = "";
    description.innerHTML = "This is the description for season 6";
})
